...
public enum ErrorCode {
    USER_ALREADY_EXISTS("A user already exists with same email", HttpStatus.BAD_REQUEST),
    ...
    EMAIL_MISMATCH("Email cannot be modified", HttpStatus.BAD_REQUEST),
    ...
    INVALID_SECTION("Invalid section", HttpStatus.BAD_REQUEST);
